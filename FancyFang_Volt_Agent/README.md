...
- Node.js 20+ 
- Git
- Ollama (Local) API Key (optional - can configure later)
  - Get your key at: https://ollama.com/download
...
- **AI Agent**: Powered by Ollama (Local) (Llama 3.2)
...
```bash
# Build image
docker build -t FancyFang_Volt_Agent .

# Run container
docker run -p 3141:3141 --env-file .env FancyFang_Volt_Agent
