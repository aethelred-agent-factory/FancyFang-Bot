...
3. **"FancyFangBot"** — Subsequent Claude sessions saw both "Fancy" and "Blenny" floating around in comments and docstrings and started blending them into a portmanteau. This persisted through several revision cycles and became the de facto internal name used throughout the codebase.
